...
1. Open Settings: Open the Claude Desktop app.
2. Edit Config: Go to Settings \> Developer \> Edit Config.
3. Open json file: Open file "claude_desktop_config"
3. Paste Configuration: Add the following entry to your mcpServers list:
